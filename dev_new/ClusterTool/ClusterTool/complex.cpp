...
namespace ayaji {
	...
	Complex& Complex::operator*= (const Complex& o) {
		this->real = this->real * o.real - this->image * o.image;
		this->image = this->real * o.image + this->image * o.real;
		return *this;
	}

	Complex& Complex::operator/= (const Complex& o) {
		double temp = 1.0 / (o.real * o.real + o.image * o.image);
		this->real = (this->real * o.real + this->image * o.image) * temp;
		this->image = (this->image * o.real - this->real * o.image) * temp;
		return *this;
	}
